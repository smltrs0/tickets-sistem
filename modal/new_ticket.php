                ...
                <div class="modal-body">
                    <form class="form-horizontal form-label-left input_mask" method="post" id="add" name="add">
                        ...
                        <div class="form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Servicio a Prestar 
                            </label>
                        ...
                        <div class="form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12">Marca / Modelo<span class="required">*</span></label>
                            <div class="col-md-9 col-sm-9 col-xs-12">
                              <input type="text" name="title" class="form-control" placeholder="Marca / Modelo" >
                            </div>
                        </div>
                        <div class="form-group">
                                ...
                                <select class="form-control" name="client_id" >
                                    <option selected="" value="">-- Selecciona --</option>
                                      <?php foreach($client as $p):?>
                                        <option value="<?php echo $p['id']; ?>"><?php echo $p['name'],' ', $p['apellido']; ?></option>
                                      <?php endforeach; ?>
                                </select>
                            </div>
                        </div>
