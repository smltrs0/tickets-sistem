    ...
    if($action == 'ajax'){
        ...
        if ($numrows>0){
            ...
            <table class="table table-striped jambo_table bulk_action">
                <thead>
                    <tr class="headings">
                        <th class="col-xs-4 column-title">Asunto </th>
                        <th class="col-xs-2 column-title">Cliente </th>
                ...
                <?php 
                        while ($r=mysqli_fetch_array($query)) {
                            ...
                            $sql = mysqli_query($con, "select * from clientes where id=$client_id");
                            if($c=mysqli_fetch_array($sql)) {
                                $name_client=$c['name'];
                                $apellido_client=$c['apellido'];
                            }
                ...
                ?>
                 ...
                 <input type="hidden" value="<?php echo $kind_id;?>" id="kind_id<?php echo $id;?>">
                    <input type="hidden" value="<?php echo $client_id;?>" id="client_id<?php echo $id;?>">
                    ...
                    <tr class="even pointer">
                        ...
                        <td><?php echo $name_client.' '.$apellido_client ?></td>
