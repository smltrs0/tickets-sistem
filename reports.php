    ...
    <div class="right_col" role="main"><!-- page content -->
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="animated headShake x_panel">
                                ...
                                <div class="input-group">
                                    ...
                                    <option value="">Cliente</option>
                                      <?php foreach($clientes as $p):?>
                                        <option value="<?php echo $p['id']; ?>" <?php if(isset($_GET["client_id"]) && $_GET["client_id"]==$p['id']){ echo "selected"; } ?>><?php echo $p['name'],' ', $p['apellido']; ?></option>
                                      <?php endforeach; ?>
                                    </select>
                                </div>
                            </div>
                        ...
                        <!-- end form search -->
                         ...
                         <?php
                                        $users= array();
                                        if((isset($_GET["status_id"]) && isset($_GET["kind_id"]) && isset($_GET["client_id"]) && isset($_GET["priority_id"]) && isset($_GET["start_at"]) && isset($_GET["finish_at"]) ) && ($_GET["status_id"]!="" ||$_GET["kind_id"]!="" || $_GET["client_id"]!="" || $_GET["priority_id"]!="" || ($_GET["start_at"]!="" && $_GET["finish_at"]!="") ) ) {
                                        ...
                                        if($_GET["priority_id"]!=""){
                                        if($_GET["status_id"]!=""||$_GET["client_id"]!=""||$_GET["kind_id"]!=""){
                                            $sql .= " and ";
                                        }
                                        ...
                                        if($_GET["status_id"]!=""||$_GET["client_id"]!="" ||$_GET["priority_id"]!="" ||$_GET["kind_id"]!="" ){
                                            $sql .= " and ";
                                        }
        ...
        <div class="x_content">
            ...
            foreach($users as $user){
                ...
                $client  = mysqli_query($con, "select * from clientes where id=$client_id");
                ...
                <?php foreach($client as $pro){?>
                <td><?php echo $pro['name'],' ',$pro['apellido']; ?></td>
                <?php } ?>
